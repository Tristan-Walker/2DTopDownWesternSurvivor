...
@onready var ammo_label = $MarginContainer/HBoxContainer/VBoxContainer/CurrentAmmo
@onready var max_ammo_label = $MarginContainer/HBoxContainer/VBoxContainer/MaxAmmo
...
func _setup_icons(max_ammo: int, layout: AmmoLayout):
	...
	for i in range(max_ammo):
		...
		if icon is Control:
			icon.custom_minimum_size = layout.icon_size
